...
export default function HoverVideoCard({
  ...
  return (
    <div
      className="group relative w-full h-80 md:h-[420px] overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 hover:shadow-2xl transition-all duration-700 transform hover:scale-[1.02] hover:-translate-y-2 cursor-pointer border border-gray-200/50"
    ...
    >
      ...
      <div className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-white/20 to-white/10 rounded-full backdrop-blur-sm border border-white/30 opacity-0 group-hover:opacity-100 transition-all duration-500 delay-200 animate-float" />
      <div className="absolute bottom-6 left-6 w-6 h-6 bg-gradient-to-br from-[#E94E1B]/20 to-[#D43D0A]/20 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 delay-300 animate-pulse" />
      ...
      <div className="relative p-8 md:p-12 h-full flex flex-col justify-center backdrop-blur-[1px]">
        ...
        <p className={`mb-8 text-lg leading-relaxed transition-all duration-700 delay-100 ${
          isHovered 
        ...
        {cta && (
          <div className={`transition-all duration-700 delay-200 ${
            ...
            <a
              href={cta.href || '#'}
              className="group/cta inline-flex items-center gap-3 px-6 py-3 text-sm rounded-full bg-gradient-to-r from-white/90 to-white/70 border border-white/60 text-gray-900 hover:from-[#E94E1B] hover:to-[#D43D0A] hover:text-white hover:border-transparent transition-all duration-500 backdrop-blur-sm font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 hover:-translate-y-1"
            >
              <span className="transition-all duration-300">{cta.label}</span>
              <div className="relative overflow-hidden">
                <span
                  className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-gradient-to-r from-[#E94E1B] to-[#D43D0A] transition-all duration-500 group-hover/cta:scale-110 group-hover/cta:rotate-45"
                >
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white transition-transform duration-300 group-hover/cta:translate-x-0.5">
        ...
        <div className={`absolute bottom-6 left-8 right-8 transition-all duration-700 ${
          ...
          <div className="mt-2 flex justify-between text-xs text-white/80 font-medium">
