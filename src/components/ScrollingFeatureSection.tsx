  ...
  const sections: Section[] = [
    {
      ...
      description:
        "Drive successful outcomes with data-driven insights and proactive engagement.",
      link: "#",
    ...
    },
    {
      ...
      description:
        "Convert clients into promoters with streamlined project management.",
      link: "#",
    ...
    },
    {
      ...
      description:
        "Close more deals faster with intelligent CRM automation and analytics.",
      link: "#",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating particles */}
        <div
          className="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/30 rounded-full animate-float"
          style={{ animationDelay: "0s", animationDuration: "8s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 w-1.5 h-1.5 bg-purple-400/40 rounded-full animate-float"
          style={{ animationDelay: "2s", animationDuration: "10s" }}
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-red-400/50 rounded-full animate-float"
          style={{ animationDelay: "4s", animationDuration: "12s" }}
        />
        <div
          className="absolute top-2/3 right-1/4 w-2.5 h-2.5 bg-indigo-400/30 rounded-full animate-float"
      ...
      <div
        className={`sticky top-0 left-0 w-full h-screen flex items-center transition-all duration-500 ease-out ${
          !sectionInView
      ...
      >
        ...
        <div
          className={`w-full md:w-1/2 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-center transform transition-all duration-700 ease-out relative z-10 ${
            hasInitialScroll
        ...
        >
          ...
          <div className="max-w-2xl relative">
            ...
            >
              {/* Premium badge */}
              <div className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-gradient-to-r from-white/60 to-white/40 border border-white/60 text-gray-700 text-xs font-medium mb-3 sm:mb-4 backdrop-blur-sm hover:scale-105 transition-transform duration-300 cursor-pointer group">
              ...
              <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent leading-tight">
                Unite your customer journey.
              </h3>

              {/* Enhanced CTA */}
              <button className="group relative bg-gradient-to-r from-[#E94E1B] to-[#D43D0A] hover:from-[#D43D0A] hover:to-[#C02D00] text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-xl font-semibold text-sm sm:text-base transition-all duration-500 hover:scale-110 hover:shadow-xl transform hover:-translate-y-1 overflow-hidden">
