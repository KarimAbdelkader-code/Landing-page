  ...
  return (
    <main className="min-h-screen bg-white scroll-smooth relative">
      ...
      <HeroShrink>
        <section
          id="hero-section"
          className="relative h-screen min-h-[520px] md:min-h-[600px] flex items-center overflow-hidden"
        >
          <div className="absolute inset-0">
            ...
            <div
              className="absolute inset-0 opacity-30 animate-aurora z-8"
              style={{
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px] bg-gradient-radial from-white/5 to-transparent rounded-full blur-3xl z-5 hidden sm:block"></div>
          <div className="absolute top-1/4 left-1/4 w-[180px] h-[180px] md:w-[300px] md:h-[300px] bg-gradient-radial from-[#E94E1B]/10 to-transparent rounded-full blur-2xl animate-pulse-slow z-6 hidden sm:block"></div>
          <div className="absolute bottom-1/4 right-1/4 w-[220px] h-[220px] md:w-[400px] md:h-[400px] bg-gradient-radial from-blue-500/8 to-transparent rounded-full blur-2xl animate-float z-7 hidden sm:block"></div>

          <div className="relative container mx-auto px-4 sm:px-6 z-20">
            <div className="max-w-3xl text-white">
              ...
              <div className="animate-fade-in-up delay-300">
                <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold mb-2 leading-[0.9] transform transition-all duration-700 hover:scale-105 cursor-default group">
              ...
              <div className="animate-fade-in-up delay-500">
                <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold mb-8 leading-[0.9] transform transition-all duration-700 hover:scale-105 cursor-default group">
              ...
              <div className="animate-fade-in-up delay-700">
                <div className="relative">
                  <p className="text-base sm:text-lg md:text-2xl mb-12 text-white/95 leading-relaxed font-light max-w-2xl">
                    The unified customer platform for growing lifelong revenue
                    through
                    <span className="relative inline-block mx-2">
                      <span className="bg-gradient-to-r from-[#E94E1B] to-orange-400 bg-clip-text text-transparent font-medium">
              ...
              <div className="animate-fade-in-up delay-900">
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-12">
                  ...
                  <button className="group relative border-2 border-white/30 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg hover:border-white hover:bg-white/10 transition-all duration-300 hover:shadow-lg backdrop-blur-sm hover:scale-105 overflow-hidden">
                    <span className="relative z-10 flex items-center gap-3">
              ...
              <div className="animate-fade-in-up delay-1100">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
                  <div className="text-center group cursor-pointer hover-lift">
                    <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent group-hover:from-[#E94E1B] group-hover:to-orange-400 transition-all duration-500 animate-breathe">
                      500+
                    </div>
                    <div className="text-white/70 mt-1 text-sm group-hover:text-white/90 transition-colors duration-300">
                      Enterprise Clients
                    </div>
      ...
      <section
        id="partners-section"
        className="py-16 sm:py-20 border-b border-gray-100 bg-gradient-to-b from-white via-gray-50/30 to-white relative overflow-hidden"
      >
          ...
          <div className="max-w-full relative overflow-hidden">
            ...
            <div className="animate-fade-in delay-300 relative">
              ...
              <LogoCarousel
                logos={[
                  {
                    src: "https://ext.same-assets.com/3038591859/261142533.svg",
                    alt: "Trend Micro",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/3258803340.svg",
                    alt: "Tele Cryptic",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/2128083783.svg",
                    alt: "Anthology",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/875789826.svg",
                    alt: "Reisestarter",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/583008813.svg",
                    alt: "Nutanix",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/505030711.svg",
                    alt: "Customer.io",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/576825794.svg",
                    alt: "Trustpilot",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/2651550302.svg",
                    alt: "Dialpad",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/3858024057.svg",
                    alt: "Nasdaq",
                  },
                  {
                    src: "https://ext.same-assets.com/3038591859/3073128413.png",
                    alt: "Medtronic",
                  },
                ]}
                speed={80}
      ...
      <section
        id="platform-section"
        className="py-32 bg-gradient-to-b from-white to-gray-50/30 relative overflow-hidden"
      >
            ...
            <div className="max-w-3xl mb-20">
              ...
              <div className="animate-fade-in-up delay-500">
                <p className="text-xl text-gray-600 leading-relaxed mb-8 max-w-2xl">
                  Unite your customer data, drive engagement, and accelerate
                  growth with our comprehensive platform designed for modern
                  enterprises.
                </p>
              </div>
      ...
      >
        ...
        <div className="absolute top-20 left-20 w-48 h-48 sm:w-72 sm:h-72 bg-gradient-to-br from-[#E94E1B]/5 to-transparent rounded-full blur-3xl animate-pulse-slow hidden sm:block"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 sm:w-64 sm:h-64 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-full blur-3xl animate-float hidden sm:block"></div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16 animate-fade-in-up">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
                  Experience the future of customer intelligence with our
                  cutting-edge AI platform
                </p>
              </div>

              <div className="group bg-gradient-to-br from-black via-gray-900 to-black text-white rounded-3xl p-8 sm:p-16 transform hover:scale-105 transition-all duration-700 hover:shadow-2xl hover:-translate-y-4 cursor-pointer overflow-hidden relative">
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up">
                    <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent leading-tight">
                      The Commercial AI Era
                    </h3>
                  </div>
                  <div className="animate-fade-in-up delay-200">
                    <p className="text-gray-300 mb-8 sm:mb-12 text-lg sm:text-xl leading-relaxed max-w-2xl">
                      Discover Planhat's flexible, integrated and commercially
                      rooted AI platform that transforms customer data into
                  ...
                  <div className="animate-fade-in-up delay-400">
                    <button className="group/btn bg-gradient-to-r from-[#E94E1B] to-[#D43D0A] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:from-[#D43D0A] hover:to-[#C02D00] transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-semibold text-base sm:text-lg">
                      <span className="flex items-center gap-3">
                        Discover AIP
                        <span className="transform transition-transform duration-300 group-hover/btn:translate-x-2">
                          →
                        </span>
                      </span>
                    </button>
      ...
      <section className="py-16 sm:py-20 bg-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <ScrollReveal>
            <div className="group bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 text-black rounded-3xl p-8 sm:p-12 max-w-2xl ml-auto transform hover:scale-105 transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 cursor-pointer overflow-hidden relative">
              ...
              <div className="relative z-10">
                <div className="animate-fade-in-up">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-4 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                    Intuitive yet deep
                  </h3>
                </div>
                <div className="animate-fade-in-up delay-200">
                ...
                <div className="animate-fade-in-up delay-400">
                  <button className="group/btn border border-black text-black px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-black hover:text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg text-sm sm:text-base">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 flex justify-center">
          <TestimonialVideoCard
            ...
            quote={
              '"I\'m already getting a lot of phone calls from people in different functions that have heard about Planhat and want to get on board."'
            }
      ...
      <section id="home-every-customer" className="relative">
        ...
        <div className="sticky top-0 h-screen flex items-center justify-center bg-gradient-to-b from-white via-gray-50/20 to-white overflow-hidden">
          ...
          <div className="absolute top-20 left-20 w-32 h-32 sm:w-64 sm:h-64 bg-gradient-to-br from-[#E94E1B]/5 to-[#D43D0A]/5 rounded-full blur-3xl animate-pulse-slow hidden sm:block"></div>
          <div className="absolute bottom-20 right-20 w-24 h-24 sm:w-48 sm:h-48 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-full blur-3xl animate-float hidden sm:block"></div>

          {/* Floating decorative elements */}
          <div
            className="absolute top-8 left-1/4 w-3 h-3 bg-[#E94E1B]/30 rounded-full animate-bounce hidden sm:block"
            style={{ animationDelay: "0s" }}
          ></div>
          <div
            className="absolute top-16 right-1/3 w-2 h-2 bg-blue-500/40 rounded-full animate-pulse hidden sm:block"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-16 left-1/3 w-2.5 h-2.5 bg-indigo-500/35 rounded-full animate-bounce hidden sm:block"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-8 right-1/4 w-1.5 h-1.5 bg-purple-500/45 rounded-full animate-pulse hidden sm:block"
            style={{ animationDelay: "3s" }}
          ></div>

          <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
            <ScrollCapture>
              <div className="scroll-area max-h-[80vh] overflow-y-auto touch-pan-y scroll-smooth bg-gradient-to-b from-white/90 to-white/70 backdrop-blur-sm rounded-3xl p-4 sm:p-8 border border-gray-200/50 shadow-2xl">
                <ScrollReveal
                  direction="scale"
                  duration={1.2}
                  stickySync={true}
                  scrollRange={[0, 0.3]}
                >
                  <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-8xl font-bold max-w-4xl mx-auto text-center leading-tight">
                    <TextReveal
                      text={
                ...
                >
                  <div className="flex justify-center items-center space-x-2">
                    ...
                    <div className="w-8 sm:w-16 h-0.5 bg-gradient-to-r from-[#E94E1B] to-[#D43D0A] rounded-full"></div>
                    <div className="text-xs sm:text-sm text-gray-500 font-medium">
                      Scroll to explore
                    </div>
                    <div className="w-8 sm:w-16 h-0.5 bg-gradient-to-l from-[#E94E1B] to-[#D43D0A] rounded-full"></div>
                    <div
                      className="w-2 h-2 bg-[#E94E1B] rounded-full animate-pulse"
          ...
          <div className="container mx-auto px-4 sm:px-6 py-20 sm:py-32">
            ...
            <ScrollReveal direction="up" duration={1.0}>
              <div className="text-center mb-12 sm:mb-20">
                <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs sm:text-sm font-medium mb-6 sm:mb-8 hover-lift">
                  <div className="w-2 h-2 bg-gradient-to-r from-[#E94E1B] to-green-400 rounded-full mr-2 sm:mr-3 animate-pulse"></div>
                  <span className="tracking-wide uppercase font-semibold">
                    Complete Platform Experience
                  </span>
                </div>
                <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent leading-tight">
                  Unified Ecosystem
                </h2>
                <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
                  Experience the perfect blend of powerful functionality and
                  consumer-ready usability in one comprehensive platform
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 max-w-7xl mx-auto">
              ...
              <ScrollReveal direction="left" duration={1.2} delay={0.2}>
                <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-700 hover:-translate-y-4 hover:shadow-2xl">
                  ...
                  <div className="absolute top-0 right-0 w-16 h-16 sm:w-32 sm:h-32 bg-gradient-to-br from-[#E94E1B]/20 to-transparent rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

                  <div className="relative z-10">
                    {/* Badge */}
                    <div className="inline-flex items-center px-3 sm:px-4 py-1 sm:py-2 bg-[#E94E1B]/20 border border-[#E94E1B]/30 rounded-full text-[#E94E1B] text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
                    ...
                    {/* Title */}
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight group-hover:text-[#E94E1B] transition-colors duration-500">
                      Unified Customer Action Hub
                    </h3>

                    {/* Description */}
                    <p className="text-gray-300 mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed group-hover:text-gray-200 transition-colors duration-500">
                      Your single source of truth and everyday customer-centric
                      control centre for sales, service, and success teams.
                    </p>

                    {/* Features List */}
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#E94E1B] to-orange-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg
                            width="10"
                            height="10"
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">
                    ...
                    {/* CTA Button */}
                    <button className="group/btn relative overflow-hidden bg-gradient-to-r from-[#E94E1B] to-orange-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:from-orange-500 hover:to-[#E94E1B] transition-all duration-500 font-semibold transform hover:scale-105 hover:shadow-xl text-sm sm:text-base">
                  ...
                  {/* Floating decorative elements */}
                  <div className="absolute top-6 sm:top-8 right-6 sm:right-8 w-8 h-8 sm:w-12 sm:h-12 border border-[#E94E1B]/30 rounded-full animate-spin-slow opacity-30 group-hover:opacity-100 transition-opacity duration-500 hidden sm:block"></div>
                  <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 w-6 h-6 sm:w-8 sm:h-8 bg-[#E94E1B]/20 rounded-full animate-pulse"></div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal direction="right" duration={1.2} delay={0.4}>
                <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-700 hover:-translate-y-4 hover:shadow-2xl">
                  ...
                  <div className="absolute top-0 right-0 w-16 h-16 sm:w-32 sm:h-32 bg-gradient-to-br from-green-500/20 to-transparent rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

                  <div className="relative z-10">
                    {/* Badge */}
                    <div className="inline-flex items-center px-3 sm:px-4 py-1 sm:py-2 bg-green-500/20 border border-green-500/30 rounded-full text-green-400 text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
                    ...
                    {/* Title */}
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight group-hover:text-green-400 transition-colors duration-500">
                      Consumer-Ready Simplicity
                    </h3>

                    {/* Description */}
                    <p className="text-gray-300 mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed group-hover:text-gray-200 transition-colors duration-500">
                      Intuitive design meets powerful functionality. Experience
                      Scandi simplicity with enterprise-grade capabilities.
                    </p>

                    {/* Features List */}
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg
                            width="10"
                            height="10"
                            className="sm:w-3 sm:h-3"
                      ...
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          ...
                          >
                            <path
                              d="M12 2L2 12h10l-1 8 10-8H11l1-10z"
                              stroke="currentColor"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
              ...
              <div className="text-center mt-20">
                <div className="max-w-4xl mx-auto">
                  ...
                  <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                    Join thousands of companies using Planhat to deliver
      ...
      <section className="py-20 sm:py-32 bg-gradient-to-b from-white to-gray-50/50 relative overflow-hidden">
        {/* Background enhancements */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50/30 to-transparent"></div>
        <div className="absolute top-20 left-20 w-32 h-32 sm:w-64 sm:h-64 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-full blur-3xl animate-float hidden sm:block"></div>
        <div className="absolute bottom-20 right-20 w-24 h-24 sm:w-48 sm:h-48 bg-gradient-to-br from-[#E94E1B]/5 to-orange-500/5 rounded-full blur-3xl animate-pulse-slow hidden sm:block"></div>
          ...
          <ScrollReveal>
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-20 animate-fade-in-up">
                <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-black/5 to-gray-800/5 border border-black/10 text-black text-xs sm:text-sm font-medium mb-6 sm:mb-8 hover-lift">
                  <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full mr-2 sm:mr-3 animate-pulse"></div>
                  <span className="tracking-wide uppercase font-semibold">
                    Advanced Analytics Engine
                  </span>
                </div>
                <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-gray-900 via-black to-gray-800 bg-clip-text text-transparent">
                  Data explorer
                </h2>
                <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
                  Access your data like never before. Anyone can transform a
                  no-code query into customer action in a matter of clicks.
                </p>
              </div>

              {/* Enhanced data visualization container */}
              <div className="bg-gradient-to-br from-black via-gray-900 to-black text-white rounded-3xl p-8 sm:p-16 text-center relative overflow-hidden group hover:scale-[1.02] transition-all duration-700 hover:shadow-2xl">
                {/* Animated background elements */}
                ...
                <div className="absolute top-6 sm:top-8 right-6 sm:right-8 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-white/5 to-white/10 rounded-full animate-pulse hidden sm:block"></div>
                <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-br from-[#E94E1B]/20 to-[#D43D0A]/20 rounded-full animate-float"></div>

                {/* Floating data points */}
                <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-blue-400 rounded-full animate-particle-float hidden sm:block"></div>
                <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-green-400 rounded-full animate-float-reverse hidden sm:block"></div>
                <div className="absolute bottom-1/3 left-1/3 w-2.5 h-2.5 bg-purple-400 rounded-full animate-breathe hidden sm:block"></div>
                <div className="absolute bottom-1/4 right-1/4 w-1.5 h-1.5 bg-yellow-400 rounded-full animate-magnetic-pull hidden sm:block"></div>

                <div className="relative z-10">
                  {/* Data metrics grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12 animate-fade-in-up delay-200">
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-2 group-hover/metric:animate-pulse">
                        15M+
                      </div>
                      <div className="text-gray-400 text-xs sm:text-sm">
                        Data Points Processed
                      </div>
                      <div className="w-8 sm:w-12 h-0.5 bg-gradient-to-r from-transparent via-blue-400 to-transparent mx-auto mt-2"></div>
                    </div>
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2 group-hover/metric:animate-pulse">
                        &lt;1s
                      </div>
                      <div className="text-gray-400 text-xs sm:text-sm">
                        Query Response Time
                      </div>
                      <div className="w-8 sm:w-12 h-0.5 bg-gradient-to-r from-transparent via-green-400 to-transparent mx-auto mt-2"></div>
                    </div>
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 group-hover/metric:animate-pulse">
                        500+
                      </div>
                      <div className="text-gray-400 text-xs sm:text-sm">
                        Custom Integrations
                      </div>
                      <div className="w-8 sm:w-12 h-0.5 bg-gradient-to-r from-transparent via-purple-400 to-transparent mx-auto mt-2"></div>
                    </div>
                  </div>

                  {/* Enhanced image container with data visualization overlay */}
                  <div className="relative aspect-video max-w-5xl mx-auto mb-8 sm:mb-12 group/image">
                    ...
                    <div className="absolute top-2 sm:top-4 left-2 sm:left-4 bg-black/50 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-1 sm:py-2 text-xs text-white/80 opacity-0 group-hover/image:opacity-100 transition-opacity duration-500">
                    ...
                    <div className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-black/50 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-1 sm:py-2 text-xs text-white/80 opacity-0 group-hover/image:opacity-100 transition-opacity duration-500">
                      <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 bg-black/50 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-1 sm:py-2 text-xs text-white/80 opacity-0 group-hover/image:opacity-100 transition-opacity duration-500">
                      <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div className="animate-fade-in-up delay-600">
                    <button className="group/cta relative bg-gradient-to-r from-white to-gray-100 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:from-gray-100 hover:to-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl font-semibold text-base sm:text-lg overflow-hidden">
                  ...
                  {/* Feature highlights */}
                  <div className="mt-8 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 animate-fade-in-up delay-800">
      ...
      <section className="py-20 sm:py-32 bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50/30 to-transparent"></div>
        <div className="absolute bottom-0 right-0 w-48 h-48 sm:w-96 sm:h-96 bg-[#E94E1B]/5 rounded-full blur-3xl animate-pulse-slow hidden sm:block"></div>
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <ScrollReveal>
            <div className="max-w-2xl mb-12 sm:mb-16 animate-fade-in-up">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                Planhat enables businesses all over the world, of every shape
                and size, to acquire, service and grow customers more
                successfully.
              </p>
              <div className="mt-4 sm:mt-6 w-16 sm:w-24 h-1 bg-gradient-to-r from-[#E94E1B] to-[#D43D0A] rounded-full"></div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {/* Software */}
            <ScrollReveal>
              <div className="group relative bg-gradient-to-br from-white via-gray-50/50 to-white p-6 sm:p-10 rounded-3xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 border border-gray-100/50 cursor-pointer overflow-hidden">
                {/* Card background effects */}
                ...
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-32 sm:h-32 bg-gradient-to-br from-[#E94E1B]/10 to-transparent rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

                <div className="relative z-10">
                  <div className="animate-fade-in-up">
                    {/* Icon */}
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#E94E1B]/20 to-[#D43D0A]/20 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                      <svg
                        className="w-5 h-5 sm:w-6 sm:h-6 text-[#E94E1B]"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                    ...
                    <h4 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 group-hover:text-[#E94E1B] transition-colors duration-300">
                      Software
                    </h4>
                    <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                      Run usage-based engagement campaigns. Deploy freemium and
                      product-led growth models at scale.
                    </p>
                    <Link
                      href="#"
                      className="inline-flex items-center gap-2 sm:gap-3 text-[#E94E1B] font-semibold hover:text-[#D43D0A] transition-all duration-300 group/link text-base sm:text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
                      </span>
                    </Link>
                  </div>
                ...
                {/* Floating indicator */}
                <div className="absolute top-4 sm:top-6 right-4 sm:right-6 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-br from-[#E94E1B] to-[#D43D0A] rounded-full animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                {/* Decorative elements */}
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 w-6 h-6 sm:w-8 sm:h-8 bg-[#E94E1B]/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-float"></div>
              </div>
            </ScrollReveal>
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up delay-100">
                    ...
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">
                      Forecast platform utilization. Deliver exceptional
                      white-glove experiences from a collaborative portal.
                    </p>
                    <Link
                      href="#"
                      className="inline-flex items-center gap-3 text-blue-600 font-semibold hover:text-blue-700 transition-all duration-300 group/link text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
              ...
              <div className="group relative bg-gradient-to-br from-white via-green-50/30 to-white p-10 rounded-3xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 border border-gray-100/50 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up delay-200">
                    ...
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">
                      Optimize staffing. Track and report on project milestones
                      and billables. Run referral programmes.
                    </p>
                    <Link
                      href="#"
                      className="inline-flex items-center gap-3 text-green-600 font-semibold hover:text-green-700 transition-all duration-300 group/link text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
              ...
              <div className="group relative bg-gradient-to-br from-white via-purple-50/30 to-white p-10 rounded-3xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 border border-gray-100/50 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up delay-300">
                    ...
                    <h4 className="text-2xl font-bold mb-4 group-hover:text-purple-600 transition-colors duration-300">
                      Connected Businesses
                    </h4>
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">
                      Monitor asset installation, schedule maintenance and
                      measure value delivery.
                    </p>
                    <Link
                      href="#"
                      className="inline-flex items-center gap-3 text-purple-600 font-semibold hover:text-purple-700 transition-all duration-300 group/link text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
              ...
              <div className="group relative bg-gradient-to-br from-white via-teal-50/30 to-white p-10 rounded-3xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 border border-gray-100/50 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up delay-400">
                    ...
                    <h4 className="text-2xl font-bold mb-4 group-hover:text-teal-600 transition-colors duration-300">
                      Healthcare & Life Sciences
                    </h4>
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">
                      Contract and streamline stakeholder management. Audit
                      inventory and predict demand.
                    </p>
                    <Link
                      href="#"
                      className="inline-flex items-center gap-3 text-teal-600 font-semibold hover:text-teal-700 transition-all duration-300 group/link text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
              ...
              <div className="group relative bg-gradient-to-br from-white via-orange-50/30 to-white p-10 rounded-3xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 border border-gray-100/50 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up delay-500">
                    ...
                    <h4 className="text-2xl font-bold mb-4 group-hover:text-orange-600 transition-colors duration-300">
                      Financial Services
                    </h4>
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">
                      Optimize staffing. Track and report on project milestones
                    ...
                    <Link
                      href="#"
                      className="inline-flex items-center gap-3 text-orange-600 font-semibold hover:text-orange-700 transition-all duration-300 group/link text-lg"
                    >
                      Explore Solution
                      <span className="transform transition-transform duration-300 group-hover/link:translate-x-2 group-hover:scale-110">
                        →
      ...
      <section className="py-20 sm:py-32 lg:py-40 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 relative overflow-hidden">
        ...
        {/* Floating ecosystem */}
        <div className="absolute top-20 left-20 w-32 h-32 sm:w-64 sm:h-64 bg-gradient-to-br from-white/20 to-white/5 rounded-full blur-3xl animate-breathe hidden sm:block"></div>
        <div className="absolute bottom-20 right-20 w-24 h-24 sm:w-48 sm:h-48 bg-gradient-to-br from-[#E94E1B]/10 to-orange-500/5 rounded-full blur-3xl animate-float-reverse hidden sm:block"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 sm:w-32 sm:h-32 bg-gradient-to-br from-blue-500/8 to-indigo-500/5 rounded-full blur-2xl animate-particle-float hidden sm:block"></div>
        <div className="absolute bottom-1/3 right-1/3 w-12 h-12 sm:w-24 sm:h-24 bg-gradient-to-br from-purple-500/8 to-pink-500/5 rounded-full blur-2xl animate-magnetic-pull hidden sm:block"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
              ...
              <ScrollReveal>
                <div className="space-y-8 sm:space-y-12 animate-fade-in-up">
                  {/* Premium badge */}
                  <div className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-white/50 to-white/30 border border-white/40 text-gray-700 text-xs sm:text-sm font-medium hover-lift cursor-pointer backdrop-blur-sm group">
                    <div className="w-2 sm:w-3 h-2 sm:h-3 bg-gradient-to-r from-[#E94E1B] to-orange-400 rounded-full mr-2 sm:mr-3 animate-pulse group-hover:animate-none"></div>
                    <span className="tracking-wide uppercase font-semibold">
                      Stay Connected
                    </span>
                  </div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <h2 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] gradient-text-animated">
                      Know them.
                    </h2>
                    <h2 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] bg-gradient-to-r from-[#E94E1B] via-orange-400 to-yellow-400 bg-clip-text text-transparent animate-gradient-x">
                      Grow them.
                    </h2>
                  </div>
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                    Get exclusive insights, product updates, and industry trends
                    delivered to your inbox. Join thousands of customer success
                    leaders.
                  </p>
                      ...
                      <div className="animate-fade-in-up delay-500">
                        <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
                          <p className="text-sm text-gray-600 leading-relaxed">
                            ...
                            emails from Planhat. You can unsubscribe at any
                            time. View our
                            <Link
                              href="#"
                              className="text-[#E94E1B] hover:text-[#D43D0A] font-medium transition-colors duration-300 hover:underline mx-1"
                            >
                              Privacy Policy
                            </Link>
                            for more details.
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-b from-white to-gray-50/50 py-12 sm:py-16 lg:py-20 border-t border-gray-100 relative overflow-hidden">
        {/* Background decorations */}
        <div className="absolute top-0 left-0 w-48 h-48 sm:w-96 sm:h-96 bg-gradient-to-br from-[#E94E1B]/3 to-transparent rounded-full blur-3xl hidden sm:block"></div>
        <div className="absolute bottom-0 right-0 w-32 h-32 sm:w-64 sm:h-64 bg-gradient-to-tl from-blue-500/3 to-transparent rounded-full blur-3xl hidden sm:block"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="mb-12 sm:mb-16 text-center">
            ...
            <p className="mt-3 sm:mt-4 text-gray-600 text-base sm:text-lg max-w-md mx-auto px-4">
              The unified customer platform for growing lifelong revenue.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div className="space-y-3 sm:space-y-4">
              <h5 className="font-bold mb-4 sm:mb-6 text-xs sm:text-sm text-gray-400 tracking-wider">
                PLANHAT
              </h5>
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                <li>
                  <Link
                    href="#"
                    className="text-gray-600 hover:text-[#E94E1B] transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    About
                  </Link>
                </li>
            ...
            <div className="space-y-4">
              <h5 className="font-bold mb-6 text-sm text-gray-400 tracking-wider">
                SOLUTIONS
              </h5>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link
                    href="#"
                    className="text-gray-600 hover:text-green-600 transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    Features
                  </Link>
                </li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link
                    href="#"
                    className="text-gray-600 hover:text-purple-600 transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    Pricing
                  </Link>
                </li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link
                    href="#"
                    className="text-gray-600 hover:text-orange-600 transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    Impact Studies
                  </Link>
                </li>
          ...
          <div className="border-t border-gray-200 pt-12">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="flex gap-8 text-sm">
                <Link
                  href="#"
                  className="text-gray-600 hover:text-[#E94E1B] transition-colors duration-300 relative group"
                >
                  Status
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <Link
                  href="#"
                  className="group flex items-center gap-2 text-gray-600 hover:text-[#E94E1B] transition-colors duration-300"
                >
                  <svg
