...
export default function Home() {
  ...
  <div className="fixed top-1/2 right-4 transform -translate-y-1/2 z-50 space-y-4 sm:space-y-4 md:right-8 md:space-y-4">
  ...
  <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-40 space-y-3 hidden sm:block">
      ...
      {/* Hero Section */}
      <HeroShrink>
  <section className="relative h-screen min-h-[520px] md:min-h-[600px] flex items-center overflow-hidden">
  ...
  <section className="py-16 sm:py-20 border-b border-gray-100 bg-gradient-to-b from-white via-gray-50/30 to-white relative overflow-hidden">
  ...
  <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <ScrollReveal>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16 animate-fade-in-up">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Powered by Advanced AI</h2>
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">Experience the future of customer intelligence with our cutting-edge AI platform</p>
              </div>
      ...
      <section id="home-every-customer" className="relative">
        ...
        <div className="sticky top-0 h-screen flex items-center justify-center bg-gradient-to-b from-white via-gray-50/20 to-white overflow-hidden">
          ...
          {/* Floating decorative elements */}
          <div className="absolute top-8 left-1/4 w-3 h-3 bg-[#E94E1B]/30 rounded-full animate-bounce hidden sm:block" style={{ animationDelay: '0s' }}></div>
          <div className="absolute top-16 right-1/3 w-2 h-2 bg-blue-500/40 rounded-full animate-pulse hidden sm:block" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-16 left-1/3 w-2.5 h-2.5 bg-indigo-500/35 rounded-full animate-bounce hidden sm:block" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-8 right-1/4 w-1.5 h-1.5 bg-purple-500/45 rounded-full animate-pulse hidden sm:block" style={{ animationDelay: '3s' }}></div>
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#E94E1B] to-orange-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg width="10" height="10" className="sm:w-3 sm:h-3" viewBox="0 0 24 24" fill="none">
                            <path d="M20 6L9 17l-5-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          </svg>
                        </div>
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">360° Customer Intelligence</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#E94E1B] to-orange-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg width="10" height="10" className="sm:w-3 sm:h-3" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">Real-time Action Center</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#E94E1B] to-orange-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg width="10" height="10" className="sm:w-3 sm:h-3" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">Cross-team Collaboration</span>
                      </div>
                    </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">Action-First Interface</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg width="10" height="10" className="sm:w-3 sm:h-3" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">Smart Shortcuts & Formulas</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item hover:translate-x-2 transition-transform duration-300">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
                          <svg width="10" height="10" className="sm:w-3 sm:h-3" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="text-gray-300 group-hover/item:text-white transition-colors duration-300 text-sm sm:text-base">Mobile-First Design</span>
                      </div>
                    </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12 animate-fade-in-up delay-200">
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      ...
                      <div className="text-gray-400 text-xs sm:text-sm">Data Points Processed</div>
                    ...
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      ...
                      <div className="text-gray-400 text-xs sm:text-sm">Query Response Time</div>
                    ...
                    <div className="text-center group/metric cursor-pointer hover-lift">
                      ...
                      <div className="text-gray-400 text-xs sm:text-sm">Custom Integrations</div>
                ...
                <div className="relative z-10">
                  <div className="animate-fade-in-up">
                    ...
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#E94E1B]/20 to-[#D43D0A]/20 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#E94E1B]" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z" clipRule="evenodd"/>
                      </svg>
                    </div>
                    <h4 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 group-hover:text-[#E94E1B] transition-colors duration-300">Software</h4>
                    ...
                    <Link href="#" className="inline-flex items-center gap-2 sm:gap-3 text-[#E94E1B] font-semibold hover:text-[#D43D0A] transition-all duration-300 group/link text-base sm:text-lg">
                      Explore Solution 
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div className="space-y-3 sm:space-y-4">
              <h5 className="font-bold mb-4 sm:mb-6 text-xs sm:text-sm text-gray-400 tracking-wider">PLANHAT</h5>
